import {
    HtmlIcon, CssIcon, JsIcon, ReactIcon, NodeIcon, TsIcon, NextIcon, MysqlIcon, MongoIcon, GdriveIcon, SocketIoIcon, RestApiIcon, PhpIcon, ViteIcon, NextAuthIcon, ReduxIcon, TailwindIcon, ZustandIcon, AstroIcon, NanostoresIcon, D3JsIcon, ReactQueryIcon, EdgeStoreIcon, JavaIcon, CppIcon
} from "../assets/icons"

import {
    numericalIcon, oopIcon, parabounceIcon, readifyIcon
} from "../assets/images"
...
const TechInfo = {
    ...
    Java: {
        title: "Java",
        description: "Object-oriented programming language known for its portability, robustness, and extensive ecosystem for building enterprise-grade applications.",
        icon: JavaIcon
    },
    Cpp: {
        title: "C++",
        description: "High-performance programming language offering low-level control and object-oriented features for system programming and complex applications.",
        icon: CppIcon
    }
};
...
export const ProjectsList: ProjectsListType = [
    {
        Name: "Parabounce",
        ShortDesc: "Interactive physics-based 2D projectile motion simulator with real-time visualization. Experiment with velocity, angle, and mass parameters to observe dynamic trajectory changes and understand fundamental physics principles through engaging visual demonstrations.",
        ...
        Source: "https://github.com/mayer-doa-coder/ParaBounce-Projectile-Motion-Simulator",
        Tech: [TechInfo.TypeScript, TechInfo.JavaScript, TechInfo.CSS],
        features: [
            {
                title: "Real-Time Simulation",
                description: "Visualize projectile motion in real-time with accurate physics calculations and smooth animations."
            },
            {
                title: "Parameter Customization",
                description: "Adjust initial velocity, angle, mass, and other parameters to see how they affect the projectile's path."
            },
            {
                title: "Interactive Visualization",
                description: "Dynamic 2D graphics that clearly illustrate trajectory, velocity vectors, and motion parameters."
            },
            {
                title: "Physics Accuracy",
                description: "Built on solid physics principles to provide accurate simulations of real-world projectile motion."
            },
    ...
    {
        Name: "Readify",
        ShortDesc: "Feature-rich Android book reading application with comprehensive library management capabilities. Offers intuitive navigation, progress tracking, customizable reading settings, and seamless organization for managing and enjoying your digital book collection on mobile devices.",
        ...
        features: [
            {
                ...
                description: "Organize and manage your digital book collection with ease. Add, remove, and categorize books efficiently."
            },
            {
                title: "User-Friendly Reading Interface",
                description: "Clean and intuitive reading experience optimized for mobile devices with customizable reading settings."
            },
            {
                title: "Progress Tracking",
                description: "Keep track of your reading progress across multiple books and resume where you left off."
            },
            {
                title: "Android Native",
                description: "Built specifically for Android platform ensuring optimal performance and native user experience."
            },
        ],
        hideProject: false,
        LogoSize: 50,
    ...
    },
    {
        ...
        ShortDesc: "Comprehensive console-based police management system developed using object-oriented C++ principles. Features efficient record handling, case management, personnel tracking, and administrative operations with robust data validation and integrity controls.",
        ...
        features: [
            {
                ...
                description: "Efficiently manage police officer records, case files, and departmental data with structured data handling."
            },
            {
                title: "Object-Oriented Design",
                description: "Built using OOP principles including classes, inheritance, encapsulation, and polymorphism for maintainable code."
            },
            {
                title: "Console Interface",
                description: "Terminal-based user interface providing straightforward access to all system functions and operations."
            },
            {
                title: "Operational Efficiency",
                description: "Streamlined workflows for handling routine police department operations and administrative tasks."
            },
            {
                title: "Data Integrity",
                description: "Robust data validation and error handling to ensure accurate and reliable record keeping."
            },
        ],
        hideProject: false,
        LogoSize: 50,
    ...
    },
    {
        ...
        ShortDesc: "Advanced numerical computation project implementing multiple mathematical algorithms in C++. Includes Newton-Raphson, Simpson's rule, Runge-Kutta methods, and more. Emphasizes computational precision, algorithmic optimization, and efficient solving of complex analytical problems.",
        ...
        features: [
            {
                ...
                description: "Implementation of various numerical techniques including Newton-Raphson, Simpson's rule, Runge-Kutta, and more."
            },
            {
                title: "Computational Accuracy",
                description: "Precision-focused algorithms that minimize numerical errors and provide reliable results for complex calculations."
            },
            {
                title: "Algorithmic Efficiency",
                description: "Optimized implementations that balance accuracy with computational performance for practical applications."
            },
            {
                title: "Complex Problem Solving",
                description: "Tackle mathematically challenging problems that require numerical approximation rather than analytical solutions."
            },
            {
                title: "Educational Tool",
                description: "Well-documented code and examples that serve as learning resources for understanding numerical methods."
            },
        ],
        hideProject: false,
        LogoSize: 50,
